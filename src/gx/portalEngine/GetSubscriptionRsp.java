...
public class GetSubscriptionRsp  implements java.io.Serializable {
    ...
    private gx.portalEngine.SubInfo[] subInfo;
    ...
    public GetSubscriptionRsp(
           ...
           gx.portalEngine.SubInfo[] subInfo) {
     ...
     * @return subInfo
     */
    public gx.portalEngine.SubInfo[] getSubInfo() {
        return subInfo;
    }
     ...
     * @param subInfo
     */
    public void setSubInfo(gx.portalEngine.SubInfo[] subInfo) {
        this.subInfo = subInfo;
    }
